        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <span className="text-2xl font-semibold tracking-tight">Waylio</span>
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Waylio, All rights reserved</span>
            </div>
        </footer>
    )
}
